 ...
 * it exposes 2 behaviors for sub-class implementation which will be used to marshal data into bytes
 * before sending and to un-marshal data from data after receiving.<br>
 *
 * @author fujohnwang
 * @see 1.0
 */
public interface IPacket {
  ...
  /**
   * marshal the {@link IPacket} state into raw bytes for sending out to network.<br>
   *

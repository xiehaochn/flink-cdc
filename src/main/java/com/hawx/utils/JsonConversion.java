...
import static com.hawx.entity.event.innodb.RowsLogBuffer.*;
...
public class JsonConversion {
  ...
  private static Json_Value parse_array_or_object(
      Json_enum_type type, LogBuffer buffer, long len, boolean large, String charsetName) {
  ...
  public static class Json_Value {
    ...
    public Json_Value(
        Json_enum_type t, LogBuffer data, long element_count, long bytes, boolean large) {
      this.m_type = t;
      this.m_data = data;
    ...
    public Json_Value element(int i, String charsetName) {
      ...
      return parse_value(
          type, m_data.rewind().forward(value_offset), (int) m_length - value_offset, charsetName);
    }

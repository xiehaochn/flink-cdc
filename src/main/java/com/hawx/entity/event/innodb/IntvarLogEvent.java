 ...
 * variables LAST_INSERT_ID or INSERT_ID. Each Intvar_log_event holds the value of one of these
 * variables. Binary Format The Post-Header for this event type is empty. The Body has two
 * components:
 *
 * <table>
...
public final class IntvarLogEvent extends LogEvent {
   ...
   *
   * <ul>
   *   <li>1 byte. A value indicating the variable type: LAST_INSERT_ID_EVENT = 1 or INSERT_ID_EVENT
   *       = 2.
   *   <li>8 bytes. An unsigned integer indicating the value to be used for the LAST_INSERT_ID()
   *       invocation or AUTO_INCREMENT column.
   * </ul>
   *

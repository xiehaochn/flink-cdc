 ...
 * each event contains only rows for one table. Also note that the row data consists of pairs of row
 * data: one row for the old data and one row for the new data.
 *

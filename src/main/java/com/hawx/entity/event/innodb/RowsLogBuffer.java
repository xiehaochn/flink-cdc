  ...
  final Serializable fetchValue(
    ...
    switch (type) {
      ...
      case LogEvent.MYSQL_TYPE_DECIMAL:
        {
           ...
           */
          logger.warn(
              "MYSQL_TYPE_DECIMAL : This enumeration value is "
      ...
      case LogEvent.MYSQL_TYPE_NEWDATE:
        {
           ...
           */
          logger.warn(
              "MYSQL_TYPE_NEWDATE : This enumeration value is "
                  + "only used internally and cannot exist in a binlog!");
          javaType = Types.DATE;
          value = null; /* unknown format */
          length = 0;
      ...
      case LogEvent.MYSQL_TYPE_TINY_BLOB:
        {
           ...
           */
          logger.warn(
              "MYSQL_TYPE_TINY_BLOB : This enumeration value is "
                  + "only used internally and cannot exist in a binlog!");
        }
      case LogEvent.MYSQL_TYPE_MEDIUM_BLOB:
        {
           ...
           */
          logger.warn(
              "MYSQL_TYPE_MEDIUM_BLOB : This enumeration value is "
                  + "only used internally and cannot exist in a binlog!");
        }
      case LogEvent.MYSQL_TYPE_LONG_BLOB:
        {
           ...
           */
          logger.warn(
              "MYSQL_TYPE_LONG_BLOB : This enumeration value is "
                  + "only used internally and cannot exist in a binlog!");
        }
      case LogEvent.MYSQL_TYPE_BLOB:
        {
      ...
      case LogEvent.MYSQL_TYPE_JSON:
        {
          ...
          if (partialBits.get(1)) {
            ...
            StringBuilder builder =
                JsonDiffConversion.print_json_diff(
                    buffer, len, columnName, columnIndex, charsetName);
            value = builder.toString();
      ...
      case LogEvent.MYSQL_TYPE_GEOMETRY:
        {
          ...
          // logger.warn(String.format("!! Unsupport column type MYSQL_TYPE_GEOMETRY: meta=%d
          // (%04X), len = %d",
          // meta,
          // meta,
          // len));
      ...
      default:
        logger.error(
            String.format(
                "!! Don't know how to handle column type=%d meta=%d (%04X)", type, meta, meta));
        javaType = Types.OTHER;
        value = null;
        length = 0;
    }

 ...
 * The event is used to inform the slave that something out of the ordinary happened on the master
 * that might cause the database to be in an inconsistent state.
 *

...
/**
 * Event for the first block of file to be loaded, its only difference from Append_block event is
 * that this event creates or truncates existing file before writing data.
 *
